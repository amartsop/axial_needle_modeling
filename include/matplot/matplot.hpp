...
{   
    public:
        ...
        void plot2D(M vec1, M vec2, std::string fmt="b", 
            int linewidth=2, int markersize=5);
    ...
    int linewidth, int markersize)
{
    ...
    std::string args[5] = {filepath_vec1, filepath_vec2, fmt, 
        std::to_string(linewidth), std::to_string(markersize)};
